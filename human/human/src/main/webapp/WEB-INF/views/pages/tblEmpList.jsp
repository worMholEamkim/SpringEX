...
<!-- DataTables CSS -->
<link
	href="/resource/vendor/datatables-plugins/dataTables.bootstrap.css"
	rel="stylesheet">

<!-- DataTables Responsive CSS -->
<link
	href="/resource/vendor/datatables-responsive/dataTables.responsive.css"
	rel="stylesheet">
...
<body>
	...
	<div id="wrapper">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-user">
						<li><a href="#"><i class="fa fa-user fa-fw"></i> User
								Profile</a></li>
						<li><a href="login"><i class="fa fa-gear fa-fw"></i>login</a>
						</li>
						<li class="divider"></li>
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">ì¸ì¬ê´ë¦¬ ë°ì¤</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">사원정보목록!</div> 
						<!-- /.panel-heading -->
							...
							<table width="100%"
								...
								<tbody id = "dataTables-employee-body">
									...
									<tr class="odd gradeX">
										...
										<td id = "empno"><a href="viewEmp?EMPNO=${recode.EMPNO}">${recode.EMPNO}</a></td>
										<td>${recode.LOCA}</td>
										<td>${recode.TITLE}</td>
										<td>${recode.INDATE.substring(0,100}</td>
										<td><a href="frmUpdEmp?EMPNO=${recode.EMPNO}" class="badge badge=danger">정보수정</a>
										...
										<button id = "dataTables-empdel-td" class="btn btn-sm btn-warning">퇴직처리</button>
										...
										<td hidden="hidden" id="sprtdate">${record.SPRTDATE.substring(0,10)}</td>
										<td hidden="hidden" id="eprtdate">${record.EPRTDATE.substring(0,10)}</td>
						...
						<!-- /.panel-body -->
						<div>
							<a href="frmAddEmp" class="btn btn-primary">사원정보 둥록</a>
						</div>
					</div>
					<!-- /.panel -->
				</div>
	...
	<script
		src="/resource/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
	<script
		src="/resource/vendor/datatables-responsive/dataTables.responsive.js"></script>
