                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="addEmployee" method="post">
										<div class="form-group">
											...
											<p class="help-block">사원번호는 입사일의 년,월,일에 두자리의 숫자를 사용하세요.(예:2018010101)!</p>
										</div>
										<div class="form-group">
											<label>성명:</label>
										...
										<div class="form-group">
 										...
 										<div class="form-group">
											...
											<p class="help-block">월급에 포함된 비과세항목으로서의 식대금액!</p>
										</div>
										<div class="form-group">
											<label>자가운전:</label>
											<input name="SELFCAR" type="number" class="form-control">
											<p class="help-block">월급에 포함된 비과세항목으로서의 자가운전금액!</p>
										</div>
										<div class="form-group">
											<label>육아수당:</label>
											<input name="BABY" type="number" class="form-control">
											<p class="help-block">월급에 포함된 비과세항목으로서의 육아수당!</p>
										</div>
										<div class="form-group">
											<label>주소:</label>
